...
{
    public class TortugaMarina : Animals
    {
        public TortugaMarina(int redemptionNumber, string dateOfRescue, string speciesToResue, int degreeOfAffect, string location, string name, int weight)
        {
        ...
        {
            return DegreeOfAffect - ((DegreeOfAffect - 2) * (2 * DegreeOfAffect + 3)) - 5;
        }
