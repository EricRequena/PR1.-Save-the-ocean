...
{
    public class Cetaci : Animals
    {
        public Cetaci(int redemptionNumber, string dateOfRescue, string speciesToResue, int degreeOfAffect, string location, string name, int weight)
        {
        ...
        {
            return DegreeOfAffect - Math.Log10(10) + 0;
        }

        public override double InfoCRAMNewDegreeOfAffect()
        {
            return DegreeOfAffect - Math.Log10(10) + 5;
        }
    }
}
